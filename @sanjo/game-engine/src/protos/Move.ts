...
export interface Move {
    /**
     * @generated from protobuf field: uint32 facingDirection = 1;
     */
    facingDirection: number;
    /**
     * @generated from protobuf field: uint32 movingDirection = 2;
     */
...
class Move$Type extends MessageType<Move> {
    constructor() {
        super("Move", [
            { no: 1, name: "facingDirection", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
            { no: 2, name: "movingDirection", kind: "scalar", T: 13 /*ScalarType.UINT32*/ }
        ]);
    }
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Move): Move {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* uint32 facingDirection */ 1:
                    message.facingDirection = reader.uint32();
                    break;
                case /* uint32 movingDirection */ 2:
    ...
    internalBinaryWrite(message: Move, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* uint32 facingDirection = 1; */
        if (message.facingDirection !== 0)
            writer.tag(1, WireType.Varint).uint32(message.facingDirection);
        /* uint32 movingDirection = 2; */
        if (message.movingDirection !== 0)
            writer.tag(2, WireType.Varint).uint32(message.movingDirection);
